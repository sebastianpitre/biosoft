...
<main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('https://images.pexels.com/photos/6992/forest-trees-northwestisbest-exploress.jpg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'); background-position: top;">
      <span class="mask bg-gradient-dark opacity-6"></span>
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-2 mt-5">¡Bienvenidos!</h1>
            <p class="text-lead text-white">Crea una cuenta para iniciar sesión.</p>
          </div>
        </div>
      </div>
    </div>
              ...
              <form role="form" method="POST" action="{{ route('register') }}">
                ...
                <!-- <div class="form-check form-check-info text-start">
                  ...
                  <label class="form-check-label" for="flexCheckDefault">
                    Acpeto los<a href="javascript:;" class="text-dark font-weight-bolder">Términos y Condiciones</a>
                  </label>
                </div> -->
                <div class="text-center">
                  <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">Regístrese</button>
                </div>
